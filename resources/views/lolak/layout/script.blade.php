...
<script src="{{ asset('assets-kecamatan/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('assets-kecamatan/vendor/glightbox/js/glightbox.min.js') }}"></script>
<script src="{{ asset('assets-kecamatan/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
