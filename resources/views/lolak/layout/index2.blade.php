                ...
                <div class="carousel-item @if($i===0) active @endif"
                    ...
                    <div class="carousel-container">
                        <div class="container" style="text-align: left">
                            ...
                            <div class="col-5">
                                <h2 class="animate__animated animate__fadeInDown" style="float: left; color:aliceblue;">
                                    {!! \Illuminate\Support\Str::limit(nl2br($post->title), 80,'...') !!}</h2>
                                <p class="animate__animated animate__fadeInUp" style="float: left; color:aliceblue;">{!!
                                    \Illuminate\Support\Str::limit(nl2br($post->body), 200,'...') !!}</p>
                                <a style="float: left;" href="{{ route('berita-detail',$post->id) }}"
                                    class="btn-get-started animate__animated animate__fadeInUp scrollto">Baca</a>
                            </div>
                            @endforeach
                ...
                <div class="row g-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="post-box">
                                    ...
                                    <p class="recent-blog-body">{!! \Illuminate\Support\Str::limit(nl2br($post->body),
                                        200,'...') !!}</p>
                    ...
                    <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div style="background-color: aliceblue; padding:5%" class="col-lg-3" data-aos="fade-up"
                                data-aos-delay="200">
                                <div class="post-box">
                                    <div class="post-img"><img src="{{ $item->image}}" class="img-fluid" alt=""></div>
                                    <div class="meta">
                                        <span style="font-size: 10px" class="post-date">
                                            {{ \Carbon\Carbon::parse($item->created_at)->diffForhumans() }}</span>
                                        <span style="font-size: 10px" class="post-author"> /
                                            {{ $item->user->name}}</span>
                                    </div>
