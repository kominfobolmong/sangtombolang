    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.leader.index') }}" method="GET">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" style="text-align: center">
                                        {{ ++$no + ($leaders->currentPage()-1) * $leaders->perPage() }}</th>
                                    <td>{{ $leader->nama }}</td>
                                    <td>{{ $leader->jabatan }}</td>
                                    <td class="text-center"><img src="{{ $leader->image }}" style="width: 20%"></td>
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "{{ route("admin.leader.index") }}/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
