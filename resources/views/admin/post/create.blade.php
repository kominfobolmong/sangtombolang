        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-book-open"></i> Tambah Pengumuman</h4>
                </div>
                    ...
                    <form action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control content @error('content') is-invalid @enderror" name="content"
                                placeholder="Masukkan Konten / Isi Pengumuman" rows="10">{!! old('content') !!}</textarea>
                            @error('content')
                            <div class="invalid-feedback" style="display: block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control content @error('embed') is-invalid @enderror" name="embed"
                                placeholder="Masukkan Embed / Link" rows="10">{!! old('embed') !!}</textarea>
                            @error('embed')
                            <div class="invalid-feedback" style="display: block">
                                {{ $message }}
                            </div>
